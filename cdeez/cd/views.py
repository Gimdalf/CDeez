				...
				for el in electiveList:
					...
					if el['courseList'] == None or el['courseList'] == []:
						...
						#If disciplines are specified
							...
							twoHundredCourses = []
							if aboveTwoHundred > 0:
								twoHundredCourses = [driver.getCoursesWithDiscipline(d, True) for d in el['fromDisciplines']]
							elective_obj['courses'] = [disciplineCourses for i in range(noOfCourses - twoHundredCourses)] + [twoHundredCourses for i in range(twoHundredCourses)]
					else:
